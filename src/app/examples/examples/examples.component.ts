...
export class ExamplesComponent implements OnInit, OnDestroy {
  ...
  examples = [
    { link: 'todos', label: 'anmf.examples.menu.todos' },
    { link: 'stock-market', label: 'anmf.examples.menu.stocks' },
    { link: 'theming', label: 'anmf.examples.menu.theming' },
    { link: 'crud', label: 'anmf.examples.menu.crud' },
    { link: 'form', label: 'anmf.examples.menu.form' },
    { link: 'authenticated', label: 'anmf.examples.menu.auth', auth: true }
  ];
